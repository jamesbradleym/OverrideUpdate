...
namespace OverrideUpdate
{
    public class Function
    {
        ...
        private UrlModelStore<OverrideUpdateInputs> store;

        public async Task<OverrideUpdateOutputs> Handler(OverrideUpdateInputs args)
        {
            ...
            if(this.store == null)
            {
                this.store = new UrlModelStore<OverrideUpdateInputs>();
            }
            

            var l = new InvocationWrapper<OverrideUpdateInputs,OverrideUpdateOutputs> (store, OverrideUpdate.Execute);
